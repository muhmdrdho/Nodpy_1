...
color_scale = LinearColormap(['darkblue','brown','blue','green','skyblue','purple','pink','cadetblue','green','lime',
                            'turquoise','aqua','blue','orange','yellow','seagreen','red','maroon','midnightblue',
