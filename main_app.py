...
clr_df = pd.read_csv("app/assets/data/color_idx.csv")
df_map3 = clr_df[["CLR_IDX"]]
...
color_scale = LinearColormap(df_map3['CLR_IDX'], vmin = min(map_dict.values()), vmax = max(map_dict.values()))
